...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    section_position: 6,
    type: 'single-choice',
    text: 'Is the building listed or in a conservation area?',
    help_text:
      'Answer "Yes" if the property is listed, locally listed, or in a conservation area. ' +
      'This does not reduce the fire-safety standard, but it may affect how doors, windows ' +
      'or compartmentation upgrades should be specified and consented.',
    options: [
      { value: 'yes', label: 'Yes — listed, locally listed, or in a conservation area' },
      { value: 'no', label: 'No — not listed and not in a conservation area' },
      { value: 'not_sure', label: 'Not sure' },
    ],
  ...
  },
  {
    ...
    section_position: 2,
    type: 'single-choice',
    text: 'Does the ground-floor flat have any bedrooms or rooms used as bedrooms?',
    help_text:
      'Only answer the following escape-window questions where the ground-floor flat has no ' +
      'rear exit and uses the shared entrance route. If a direct exit exists, the tool does ' +
      'not drive window-based remedies for the ground-floor flat.',
    show_when: [
      { when_question: 'B1', has_value: 'communal' },
      { when_question: 'B3', has_value: 'no' },
    ],
    options: [
      { value: 'yes', label: 'Yes — at least one bedroom or formal sleeping room' },
      { value: 'no', label: 'No — no bedrooms / formal sleeping rooms' },
      { value: 'not_sure', label: 'Not sure' },
    ],
    uncertainty_behaviour: 'CONSERVATIVE',
    required: true,
  ...
  },
  {
    ...
    section_position: 3,
    type: 'single-choice',
    text: 'Does the main bedroom in the ground-floor flat have a window that can be opened?',
    show_when: [
      { when_question: 'B1', has_value: 'communal' },
      { when_question: 'B3', has_value: 'no' },
      { when_question: 'GF_C0', has_value: ['yes', 'not_sure'] },
    ],
    options: [
  ...
  },
  {
    ...
    section_position: 4,
    type: 'single-choice',
    text: 'What type of opening does the ground-floor bedroom window have?',
    show_when: [{ when_question: 'GF_C1', has_value: 'yes' }],
    options: [
      { value: 'side_hung', label: 'Side-hung casement — opens to the side like a door' },
      { value: 'sash', label: 'Sash window — slides up and down' },
      { value: 'top_hung_only', label: 'Top-hung only — tilts inward at the top' },
      { value: 'full_height_door', label: 'Full-height glazed door with an opening panel' },
  ...
  },
  {
    ...
    section_position: 5,
    type: 'single-choice',
    text: 'Can the ground-floor bedroom window be opened without using a key?',
    show_when: [{ when_question: 'GF_C1', has_value: 'yes' }],
    options: [
  ...
  },
  {
    ...
    section_position: 6,
    type: 'single-choice',
    text: 'Is the ground-floor bedroom window sill at approximately 1,100mm or less above the floor?',
    show_when: [{ when_question: 'GF_C1', has_value: 'yes' }],
    options: [
  ...
  },
  {
    ...
    section_position: 7,
    type: 'single-choice',
    text: 'When fully open, does the ground-floor bedroom window provide a clear openable area of at least 0.33 square metres?',
    show_when: [{ when_question: 'GF_C1', has_value: 'yes' }],
    options: [
  ...
  },
  {
    ...
    section_position: 8,
    type: 'single-choice',
    text: 'Is there any obstruction below or outside the ground-floor bedroom window that would prevent escape or rescue?',
    show_when: [{ when_question: 'GF_C1', has_value: 'yes' }],
    options: [
      { value: 'no', label: 'No — no obstruction below or outside the window' },
      { value: 'yes', label: 'Yes — conservatory, railings, or other obstruction present' },
      { value: 'not_sure', label: 'Not sure' },
    ],
    uncertainty_behaviour: 'CONSERVATIVE',
    required: true,
  ...
  },
  {
    ...
    section_position: 9,
    type: 'single-choice',
    text: 'Is there a second bedroom in the ground-floor flat?',
    show_when: [
      { when_question: 'B1', has_value: 'communal' },
      { when_question: 'B3', has_value: 'no' },
      { when_question: 'GF_C0', has_value: ['yes', 'not_sure'] },
  ...
  },
  {
    ...
    section_position: 10,
    type: 'single-choice',
    text: 'Does the ground-floor bedroom 2 have a window that can be opened?',
    show_when: [{ when_question: 'GF_C6', has_value: 'yes' }],
    options: [
      { value: 'yes', label: 'Yes — the bedroom has an openable window' },
      { value: 'no', label: 'No — fixed or sealed window, or no window' },
      { value: 'not_sure', label: 'Not sure' },
  ...
  },
  {
    ...
    section_position: 11,
    type: 'single-choice',
    text: 'Can the ground-floor bedroom 2 window be opened without using a key?',
    show_when: [{ when_question: 'GF_C7', has_value: 'yes' }],
    options: [
  ...
  },
  {
    ...
    section_position: 12,
    type: 'single-choice',
    text: 'Is the ground-floor bedroom 2 window sill at approximately 1,100mm or less above the floor?',
    show_when: [{ when_question: 'GF_C7', has_value: 'yes' }],
    options: [
  ...
  },
  {
    ...
    section_position: 13,
    type: 'single-choice',
    text: 'When fully open, does the ground-floor bedroom 2 window provide a clear openable area of at least 0.33 square metres?',
    show_when: [{ when_question: 'GF_C7', has_value: 'yes' }],
    options: [
      { value: 'yes', label: 'Yes — appears to provide at least 0.33m² clear opening' },
      { value: 'no', label: 'No — opening appears smaller than 0.33m²' },
  ...
  },
  {
    ...
    section_position: 14,
    type: 'single-choice',
    text: 'Is there any obstruction below or outside the ground-floor bedroom 2 window that would prevent escape or rescue?',
    show_when: [{ when_question: 'GF_C7', has_value: 'yes' }],
    options: [
  ...
  },
  {
    ...
    section_position: 15,
    type: 'single-choice',
    text: 'Is there any bedroom in the ground-floor flat that can only be reached by passing through another habitable room?',
    show_when: [
      { when_question: 'B1', has_value: 'communal' },
      { when_question: 'B3', has_value: 'no' },
      { when_question: 'GF_C0', has_value: ['yes', 'not_sure'] },
    ...
    options: [
      { value: 'no', label: 'No — all bedrooms open onto a hallway or lobby directly' },
      { value: 'yes', label: 'Yes — at least one bedroom is reached through another habitable room' },
      { value: 'not_sure', label: 'Not sure' },
    ],
  ...
  },
  {
    ...
    section_position: 16,
    type: 'single-choice',
    text: 'Can the main ground-floor bedroom be reached from the flat entrance without passing through a habitable room?',
    show_when: [
      { when_question: 'B1', has_value: 'communal' },
      { when_question: 'B3', has_value: 'no' },
      { when_question: 'GF_C0', has_value: ['yes', 'not_sure'] },
    ...
    options: [
      { value: 'yes', label: 'Yes — bedroom opens directly from a hallway or lobby' },
      { value: 'no', label: 'No — must pass through a living room or another habitable room' },
      { value: 'not_sure', label: 'Not sure' },
    ],
    uncertainty_behaviour: 'CONSERVATIVE',
    required: true,
  ...
  },
  {
    ...
    section_position: 4,
    type: 'single-choice',
    text: 'Is the loft / upper level served by a protected internal stair, or does it have its own secondary means of escape?',
    help_text:
      'For a two-level upper flat or loft conversion, rooms above about 4.5m cannot rely on ' +
      'escape windows alone. A protected internal route or a separate secondary escape route ' +
      'may be needed for the upper level.',
    show_when: [{ when_question: 'B6', has_value: 'two_level_maisonette' }],
    options: [
      {
        value: 'protected_internal_route',
        label: 'Yes — protected internal stair / route serving the upper level',
      },
      {
        value: 'secondary_escape',
        label: 'Yes — separate secondary escape route from the loft / upper level',
      },
      {
        value: 'no',
        label: 'No — no confirmed protected internal route or secondary escape',
      },
      { value: 'not_sure', label: 'Not sure' },
    ],
    uncertainty_behaviour: 'CONSERVATIVE',
  ...
  },
  {
    ...
    section_position: 5,
    type: 'single-choice',
    text: 'Does the external steel staircase have suitable weather protection, slip-resistant treads and safe condition for wet weather use?',
    help_text:
      'LACORS §18.2 expects external escape stairs to remain safe and usable in poor weather. ' +
      'Consider whether treads, landings and handrails are sound, slip-resistant, drained and ' +
      'maintained so the route can be used in an emergency.',
    show_when: [{ when_question: 'B2', has_value: 'yes_external_steel_stair' }],
    options: [
      { value: 'yes', label: 'Yes — appears suitable for wet weather use' },
      { value: 'no', label: 'No — weather exposure, slippery treads or condition concerns' },
      { value: 'unknown', label: 'Not sure' },
    ],
    uncertainty_behaviour: 'CONSERVATIVE',
    required: true,
